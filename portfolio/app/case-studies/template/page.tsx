    ...
    <article className="flex flex-col items-center prose prose-base prose-slate max-w-full">
      ...
      >
        ...
        <img
          ...
          className="max-w-7xl w-full md:w-2/3 not-prose"
        ></img>
      </section>

      <div className="p-6 flex flex-col items-center gap-4 md:gap-8">
          ...
          <div>
            ...
            <div className="max-w-prose">
              ...
              <p>
                ...
                features, benefits, and target users of Watchdog. I took on the
                role of both designer and frontend developer to create this
                captivating landing page. By leveraging graphical elements
                sourced from Freepik, I tailored them to align with the Watchdog
                brand, creating a cohesive brand experience.
              </p>
            </div>
          </div>
          <div>
            ...
            <div className="max-w-prose">
              ...
              <p>
                ...
                our large language AI model, which promptly analyzes the content
                and provides valuable insights regarding its likelihood of being
                a scam, misinformation, or AI-generated.
              </p>
            </div>
          </div>
          <div>
            ...
            <div className="max-w-prose">
              ...
              <p>
                ...
                experience, ensuring uninterrupted exploration while effectively
          ...
          <div>
            ...
            <div className="max-w-prose">
              ...
              <p>
                ...
                swiftly evaluates the content for suspicious material, allowing
                users to prioritize their browsing without any disruptive
                interruptions.
              </p>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-2 lg:px-8 gap-4 md:gap-16 items-end lg:px-8">
          <div>
          ...
          <div className="grid lg:grid-cols-2 gap-4 gap-y-0 md:gap-8 md:gap-y-0">
            <div>
              <h4>Color palette</h4>
              <p>
                ...
                reasons, we deliberately selected blue as the primary color for
                Watchdog.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                adaptability make it ideal for diverse design contexts. Whether
                for headings or body text, this font provides flexibility across
                various UI components and layouts, enhancing the overall visual
                appeal and readability of the web application.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Watchdog, the tone of voice employed within the web application
                does not need to be so complicated. To ensure accessibility for
                users who may not be well-versed in technology, we deliberately
                eliminate the use of jargon and strive to make our written
                communications as simple as possible.
              </p>
            </div>
            ...
            <div>
              <h4>Imagery</h4>
              <p>
                We selected Watchdog as the name for our web application because
                of the symbolic representation of dogs as guardians. Much like
                ...
                throughout the application to reinforce the notion of
        ...
        <div className="max-w-4xl">
          ...
          <div className="max-w-4xl">
            <Overline color="blue" text="Up next"></Overline>
            <ProjectCard
              title="Chow Now"
