      ...
      <div className="grid gap-12 lg:gap-16 lg:grid-cols-2 pt-40">
        ...
        <section className="prose prose-base">
          ...
          <p>
            ...
            best harness the full potential of my background in computer science
            and my proficiency in design to craft design systems. As a designer,
            I strive to provide design solutions that are both user-focused and
            technically-feasible.
          </p>
          <p>
            When I am not tinkering away on Figma, I write tales of feminist
            heroines in kingdoms of magic and dragons, play an ungodly amount of
