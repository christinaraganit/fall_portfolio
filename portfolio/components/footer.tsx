export default function Footer() {
  return (
    <footer className="px-4 mt-20 border-t text-sm border-slate-200/80 pb-6 pt-4 max-w-full py-12 max-w-full flex flex-col gap-4 lg:gap-8 xl:gap-12 items-center">
      <div className="pl-2 pr-2 max-w-5xl w-full flex flex-col gap-4 lg:flex-row items-center">
