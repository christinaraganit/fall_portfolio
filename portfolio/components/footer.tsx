export default function Footer() {
  return (
    <footer className="mt-8 md:mt-20 border-t text-sm border-slate-200/80 pb-6 pt-4 max-w-full py-12 max-w-full flex flex-col gap-4 lg:gap-8 xl:gap-12 items-center">
