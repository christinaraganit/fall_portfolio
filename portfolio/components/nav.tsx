...
export default function Nav() {
  ...
  return (
    <>
      ...
      <nav
        className="fixed mx-4 my-8 right-4 pointer-events-auto md:hidden"
      >
        <button
        ...
        <Dialog as="div" onClose={() => setModalOpen(false)} open={modalOpen}>
          ...
          <Dialog.Panel className="fixed inset-x-4 top-4 my-8 z-50 origin-top rounded-3xl bg-white p-8 ring-1 ring-zinc-900/5 opacity-100 scale-100">
