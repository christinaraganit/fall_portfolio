      ...
      <main className="max-w-full flex flex-col items-center">
        <div className="max-w-4xl w-full flex flex-col">
          <div className="prose prose-base p-6 pt-20 md:pt-40">
            ...
            <h1>Hi, I'm Christina Raganit, a Vancouver-based UX designer.</h1>
            <p>
          ...
          <div className="px-6 mt-4 mb:mt-8">{props.children}</div>
        </div>
      </main>
    );
    ...
    return (
      <main className="max-w-full flex flex-col items-center">
        <div className="w-full flex flex-col items-center">
          <div className="max-w-4xl prose prose-base p-6 pt-20 md:pt-40">
